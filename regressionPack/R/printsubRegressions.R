#' Print
#'
#' Print function for a \code{subRegressions} object
#'
...
#' @rdname printsubRegressions
#' @aliases print,subRegressions-method
#' @export
setMethod("print","subRegressions",function(x,...){
	for(i in 1:length(x@Rsquared)){
		...
		cat("For model",i,"pvalues are",paste(x@pvalues[i,],collapse=","),"\n\n")
	}
})