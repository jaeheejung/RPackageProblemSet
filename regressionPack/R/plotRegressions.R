#' Plot the rsquared values of the models
#'
#' Plot function for a \code{Regressions} object
#'
...
#' plot(regressionsObject)
#' @rdname plotRegressions
#' @aliases plot,Regressions-method
#' @export ##This function returns a plot with each linear model in the x-axis and the respective Rsquared values in the y-axis.
